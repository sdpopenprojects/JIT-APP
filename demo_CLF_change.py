...
if __name__ == '__main__':
    ...
    save_path = r'./result_change/NB/'

    CLF = 'NB' # 'NB','DT','GBM','KNN','LR'
    ...
    for i in range(0, pro_num):
        ...
        if CLF == 'RF':
            ...
            study.optimize(lambda trial:rf_objective(trial, train_data, train_label, val_data, val_label), n_trials=30, n_jobs=1)
            ...
            study.optimize(lambda trial: knn_objective(trial, train_data, train_label, val_data, val_label,n_features), n_trials=30,
                           n_jobs=1)
            ...
            study.optimize(lambda trial: gbm_objective(trial, train_data, train_label, val_data, val_label,n_features), n_trials=30,
                           n_jobs=1)
        ...
        for i in range(Rep):
            if CLF == 'RF':
                ...
                model = DecisionTreeClassifier(criterion=criterion, max_depth=max_depth,min_samples_leaf=min_samples_leaf,random_state=i+1)
